...
\begin{abstract}
    ...
    by Gradient Descent, Stochastic Gradient Descent, Adam, Lion and Muon applied to Multi-Layer
    Perceptron on the Fashion-MNIST dataset \cite{xiao2017/online}. To this end, we use a linear interpolation method: for each discrete update
